...
const normalizeNotes = async (content) => {
   try {
      const requestBody = {
         contents: {
            parts: {
               text: `You are an expert Translator. You are tasked to normalize id text.Please provide an accurate normalization of this phrase and return the result text only in id: ${content}`,
            },
         },
      };
      ...
      return aiResponse.data.normalized_content;
   } catch (error) {
      console.error("Error normalizing notes:", error.message);
