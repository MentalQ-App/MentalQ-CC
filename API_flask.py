...
# Load trained model dalam format SavedModel
try:
    model = tf.keras.models.load_model('model.h5')  # Ganti path jika berbeda
...
try:
    ...
    logging.info("Data preprocessed berhasil dimuat.")
except Exception as e:
